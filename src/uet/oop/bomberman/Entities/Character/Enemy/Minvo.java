...
public class Minvo extends Enemy {
    ...
    private void setFrameRight() {
        Image right0 = Sprite.minvo_right1.getFxImage();
        Image right1 = Sprite.minvo_right2.getFxImage();
        Image right2 = Sprite.minvo_right3.getFxImage();
    ...
    private void setFrameLeft() {
        Image left0 = Sprite.minvo_left1.getFxImage();
        Image left1 = Sprite.minvo_left2.getFxImage();
        Image left2 = Sprite.minvo_left3.getFxImage();
